...
struct SlangDataDummy: Hashable {
    let slang: String
...
class SlangDictionaryDummy {
    static let shared = SlangDictionaryDummy()
    
    let slangs: [String: SlangDataDummy] = [
        "gue": SlangDataDummy(
            slang: "gue",
    ...
    func findSlang(in text: String) -> [SlangDataDummy] {
        let lowercased = text.lowercased()
        var found: [SlangDataDummy] = []
